...
def run():
    for k, v in dic_list.items():
        ...
        for i in v:
            ...
            str = "esmini --window 60 60 800 400 --osc /home/Rupeng119_com/esmini/resources/xosc/{}.xosc --fixed_timestep 0.033 --capture_screen".format(
                i)
            os.system(str)
            mp4Cmd = "ffmpeg -f image2 -framerate 30 -i screen_shot_%5d.tga -c:v libx264 -qp 0 out.mp4"
            os.system(mp4Cmd)
